...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        for action in Nim.available_actions(state):
            res = max(res, self.get_q_value(state, action))
    ...
    def choose_action(self, state, epsilon=True):
        ...
        choices = [random.choice(list(Nim.available_actions(state))), self.greedy_choice(state)]
    ...
    def greedy_choice(self, state):
        ...
        for action in Nim.available_actions(state):
            if self.get_q_value(state, action) >= highestQvalue:
                highestQvalue = self.get_q_value(state, action)
                bestAction = action
